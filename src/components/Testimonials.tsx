        ...
        <div >
          ...
          <div className="team-grid" style={{ marginLeft: 'auto', marginRight: 'auto', width: '80%' }}>
            ...
            <div className="testim-box" >
              <p style={{marginBottom: "0px"}}>"These NFTs are literally Shit"</p>
            ...
            <div className="testim-box">
              <p style={{marginBottom: "0px"}}>"They took shit and put it on the Blockchain"</p>
              <div className="team-card">
            ...
            <div className="testim-box">
              <p style={{marginBottom: "0px"}}>"This may be the shittiest NFT Project we've seen"</p>
              <div className="team-card">
      ...
      <div className="testim">
        <div >
          ...
          <div className="team-grid" style={{ marginLeft: 'auto', marginRight: 'auto', width: '80%' }}>
            ...
            <div className="testim-box">
              <p style={{marginBottom: "0px"}}>"We'd rather burn our money than invest in this.."</p>
              <div className="team-card">
            ...
            <div className="testim-box">
              <p style={{marginBottom: "0px"}}>"How do people even find value in this shit. I can't believe they're buying it."</p>
              <div className="team-card">
            ...
            <div className="testim-box">
              <p style={{marginBottom: "0px"}}>"I don't want to buy your shit..Fuck off you DONKEY! "</p>
              <div className="team-card">
