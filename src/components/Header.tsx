      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2" style={{ width: "100%" }}>
          <div className="columnsTwo">
            <img src="MagicSolanaShit.JPG" alt="" style={{ marginTop: "75px" }} />
            <div className="text-6xl columnTwo" style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 900, fontStyle: "italic", fontSize: "22px", marginLeft: "75px", color: "black" }}>6,969 <u>Unique</u> Shits!</div>
            <div style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 700, marginLeft: "75px", paddingTop: "10px" }}>Magic Solana Shits are a collection of 6,969 unique generative NFT's existing on the Solana Blockchain. This project is the SHIT! </div>
            <div style={{ padding: "13px", marginLeft: "60px" }}>
              <Home
        ...
        <h2 style={{fontFamily: "Montserrat, sans-serif", fontWeight: 900, color: "white", fontSize: "36px", textAlign: "center", }}><i>WELCOME TO THE SHIT-SHOW!</i></h2>
      </div>
    </div>
